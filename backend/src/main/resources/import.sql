...
INSERT INTO app_user (id, username, email, password, profile_picture_path, short_description, role, enabled, locked) VALUES (nextval('user_sequence'), 'a', 'u@user.com', '$2a$12$Sze0MTTDf1ySwSeQ6yllyeQZawfEC/iBddWcDPhHOGawKsAmAsGPq', 'path', 'description', 'ADMIN', TRUE, FALSE);