...
import Games from "./pages/ListContent/Games/Games";
import Chat from "./pages/Chat";
import Login from "./pages/Login/Login";
import Registration from "./pages/Registration/Registration";
import Home from "./pages/Home/Home";
import Reviews from "./pages/ListContent/Reviews/Reviews";
...
import Articles from "./pages/ListContent/Articles/Articles";
